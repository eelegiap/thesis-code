function drawChart(result) {
    ...
    $('#graph-title').text('2-D Representation of the closest  forms to ')
    ...
    var startvectors = []
    var labels = []
    result = result.increase.NOUN
    console.log(result.length)
    result.forEach(function (elt) {
        startvectors.push(elt.vector)
        labels.push(`${elt.word} (${elt.translatedword})`)
    })
